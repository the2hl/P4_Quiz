 ...
 * existe, y se producirá el error ENOENT. En este caso se salba el contenido
 * inicial almacenado en quizzes.
...
exports.update = (id, question, answer) => {
	...
	//en la posicion id, quito 1 elemento y anado
	quizzes.splice(id, 1, {
		question: (question || "").trim(),
		answer: (answer || "").trim()
	});
 ...
 * Devuelve un clon del valor guardado en las variables quizzes, es decir devuelve un
...
exports.deleteByIndex = id => {
	...
	//en la posicion id quito 1 elemento
	quizzes.splice(id, 1);
	save();
};
